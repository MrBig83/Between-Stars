...
namespace Between_Stars.Classes
{
    public class CelestialBody
    {
        ...
        public List<int> ConnectedBodies { get; set; } // ID:n på andra CelestialBodies som man kan resa till
        ...
        public CelestialBody(int id, string name, int x, int y, int z,
            List<InventoryEntry> inventory = null, List<int> connectedBodies = null)
        {
            Id = id;
            Name = name;
            Position = new Position { X = x, Y = y, Z = z };
            Inventory = inventory ?? new List<InventoryEntry>();
            ConnectedBodies = connectedBodies ?? new List<int>();
        }
    }
